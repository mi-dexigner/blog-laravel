            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="user-block block text-center">
                  ...
                  </div><a href="admin/#" class="user-title">
            ...
            <div class="public-user-block block">
              <div class="row d-flex align-items-center">                   
                <div class="col-lg-4 d-flex align-items-center">
                  ...
                  <div class="avatar"> <img src="admin/img/avatar-1.jpg" alt="..." class="img-fluid"></div><a href="admin/#" class="name"><strong class="d-block">Tomas Hecktor</strong><span class="d-block">@tomhecktor</span></a>
                </div>
            ...
            <div class="public-user-block block">
              <div class="row d-flex align-items-center">                   
                <div class="col-lg-4 d-flex align-items-center">
                  ...
                  <div class="avatar"> <img src="admin/img/avatar-2.jpg" alt="..." class="img-fluid"></div><a href="admin/#" class="name"><strong class="d-block">Alexander Shelby</strong><span class="d-block">@alexshelby</span></a>
                </div>
                <div class="col-lg-4 text-center">
            ...
            <div class="public-user-block block">
              <div class="row d-flex align-items-center">                   
                <div class="col-lg-4 d-flex align-items-center">
                  ...
                  <div class="avatar"> <img src="admin/img/avatar-6.jpg" alt="..." class="img-fluid"></div><a href="admin/#" class="name"><strong class="d-block">Arther Kooper</strong><span class="d-block">@artherkooper</span></a>
                </div>
                <div class="col-lg-4 text-center">
            ...
            <div class="row">
              ...
              <div class="col-lg-6">                                           
                <div class="messages-block block">
                  ...
                  <div class="messages"><a href="admin/#" class="message d-flex align-items-center">
                      <div class="profile"><img src="admin/img/avatar-3.jpg" alt="..." class="img-fluid">
                        <div class="status online"></div>
                      </div>
                      <div class="content">   <strong class="d-block">Nadia Halsey</strong><span class="d-block">lorem ipsum dolor sit amit</span><small class="date d-block">9:30am</small></div></a><a href="admin/#" class="message d-flex align-items-center">
                      <div class="profile"><img src="admin/img/avatar-2.jpg" alt="..." class="img-fluid">
                        <div class="status away"></div>
                      </div>
                      <div class="content">   <strong class="d-block">Peter Ramsy</strong><span class="d-block">lorem ipsum dolor sit amit</span><small class="date d-block">7:40am</small></div></a><a href="admin/#" class="message d-flex align-items-center">
                      <div class="profile"><img src="admin/img/avatar-1.jpg" alt="..." class="img-fluid">
                        <div class="status busy"></div>
                      </div>
                      <div class="content">   <strong class="d-block">Sam Kaheil</strong><span class="d-block">lorem ipsum dolor sit amit</span><small class="date d-block">6:55am</small></div></a><a href="admin/#" class="message d-flex align-items-center">
                      <div class="profile"><img src="admin/img/avatar-5.jpg" alt="..." class="img-fluid">
                        <div class="status offline"></div>
                      </div>
                      <div class="content">   <strong class="d-block">Sara Wood</strong><span class="d-block">lorem ipsum dolor sit amit</span><small class="date d-block">10:30pm</small></div></a><a href="admin/#" class="message d-flex align-items-center">
                      <div class="profile"><img src="admin/img/avatar-1.jpg" alt="..." class="img-fluid">
                        <div class="status online"></div>
                      </div>
